...
class StockDataTable extends DataTable
{
    ...
    public function dataTable($query): DataTableAbstract
    {
        ...
        return datatables()->eloquent($query)->editColumn('action', function ($model) {
                return view('transactions::stock._action', compact('model'));
    ...
    {
        return $model->newQuery()->with('account')->where('stock_type','stockIn');
    }
    ...
    {
        return $this->builder()->setTableId('stock-datatable-table')->columns($this->getColumns())->minifiedAjax()->dom('Bfrtip')->orderBy(1)->buttons(Button::make('create'), Button::make('export'), Button::make('print'), Button::make('reset'), Button::make('reload'));
    }
