            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        ...
                        {!! Form::select('country_id',\App\Models\Country::pluck('name','id')->prepend('Select', null),null,['class'=>'country form-control ']) !!}
                        @error('country_id')
                        <span class="help-block text-danger">
                            {{ $message }}
                        </span>
                    ...
                    <div class="col-md-4 col-sm-12 mb-3">
                        ...
                        {!! Form::select('city_id',[],null,['class'=>' city form-control']) !!}
                        @error('city_id')
                        <span class="help-block text-danger">
                            {{ $message }}
                        </span>
