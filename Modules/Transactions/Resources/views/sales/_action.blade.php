...
<a href="{{ route('transactions.sales.print',$model->id) }}" class="" data-id="{{ $model->id }}"><i
        class="fa fa-print text-dark"></i></a> |
{!! Form::open(['method'=>'DELETE','route'=>['transactions.sales.destroy',$model->id],'class'=>'delete-form','style'=>'display:inline']) !!}
