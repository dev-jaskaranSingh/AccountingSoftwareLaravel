...
<body class="px-4">
			...
			<div class="col-md-6" style="border-right: 2px solid rgb(55, 55, 55)!important;padding: 15px!important;">
				<table>
					<tr>
						...
						<td>:</td>
						<td>JYOTICHAND BHAICHAND SARAF & SONS PVT
							LTD, JAYSHRI COMPLEX ,STATION ROAD ,
							BARAMATI ,DIST-PUNE.</td>
					</tr>
					<tr>
						<th width="25%">GSTIN</th>
						<td>:</td>
						<td>27AABCJ0956C1ZV</td>
					</tr>
					<tr>
						<th width="25%">PAN</th>
						<td>:</td>
			...
			<div class="col-md-6" style="padding: 15px!important;">
				<table>
					...
					<tr>
						...
						<td>:</td>
						<td>JYOTICHAND BHAICHAND SARAF & SONS
							PVT LTD,
							JAYSHRI COMPLEX ,STATION ROAD ,
							BARAMATI ,DIST-PUNE.</td>
					</tr>
				</table>
			</div>
	...
	<table class="w-100" border="2">
		...
		<tbody>
			<tr>
				<td>1</td>
				<td>Lorem ipsum dolor STATION</td>
				<td>232H4</td>
				<td>40G</td>
				<td>23G</td>
				<td>10,000/1G</td>
			...
			<tr>
				...
				<td style="line-height: 40px !important;"></td>
				<td style="line-height: 40px !important;">0.000</td>
				<td style="line-height: 40px !important;">0.000</td>
				<td style="line-height: 40px !important;"></td>
				<td style="line-height: 40px !important;"><strong>₹ 0.00</strong></td>
