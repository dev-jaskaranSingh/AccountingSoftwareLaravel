...
class SaleServices
{
     ...
     * @return mixed
     */
    public static function saveSaleInFinanceLedger($type, $purchaseModel, $request): mixed
    {
        $SALE_ID = 30;
        $CGST_INPUT_ID = 20;
        $SGST_INPUT_ID = 21;
        ...
        $partyPurchaseInsertArray = [
            ...
            'debit' => $purchaseModel->grand_total_amount,
            'credit' => 0,
            'narration' => '',
            'bill_type' => $type,
        ...
        if (!is_null($purchaseModel->round_off_value)) {
            ...
            $insertArray[] = [
                ...
                'bill_number' => $purchaseModel->invoice_number,
                'bill_date' => $purchaseModel->bill_date,
                'debit' => $purchaseModel->round_off_value,
                'credit' => 0,
                'narration' => '',
                'bill_type' => $type,
    ...
    public static function saveSaleStockMaster($purchaseItems, $voucher_type, $purchase_id,$bill_date,$account_id, $invoice_number){

        $insertData = $purchaseItems->map(fn($item) => [
