                        ...
                        <tr>
                            ...
                            <td>
                                <input type="checkbox" name="forms[{{ $form->id }}][create]" value="1"
                                       @if(isset($userFormsPermission->create) && ($userFormsPermission->create == 1)) checked @endif>
                            </td>
                            <td>
                                <input type="checkbox" name="forms[{{ $form->id }}][read]" value="1"
                                       @if(isset($userFormsPermission->read) && ($userFormsPermission->read == 1)) checked @endif>
                            </td>
                            <td>
                                <input type="checkbox" name="forms[{{ $form->id }}][update]" value="1"
                                       @if(isset($userFormsPermission->update) && ($userFormsPermission->update == 1)) checked @endif>
                            </td>
                            <td>
                                <input type="checkbox" name="forms[{{ $form->id }}][delete]" value="1"
                                       @if(isset($userFormsPermission->delete) && ($userFormsPermission->delete == 1)) checked @endif>
                            </td>
                        </tr>
                    @endforeach
                    </tbody>
