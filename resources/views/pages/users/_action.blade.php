<a href="{{ route('admin.users.show',$model->id) }}" class="" data-id="{{ $model->id }}"><i
        class="fa fa-eye text-info"></i></a> |
<a href="{{ route('admin.users.edit',$model->id) }}" class="" data-id="{{ $model->id }}"><i
...
{!! Form::close() !!} |
<a href="{{ route('admin.users.edit.password',$model->id) }}" class="" data-id="{{ $model->id }}">
    <i
        class="fa fa-lock text-primary"></i></a>
